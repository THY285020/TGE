...
void TGE::EditorLayer::OnImGuiRender()
{
...
void TGE::EditorLayer::OnUpdate(TimeStep& ts)
{
    //--------interval--------------
    if (time_temp >= 1.0) {
...
void TGE::EditorLayer::OnEvent(TGE::Event & event)
{
...
void TGE::EditorLayer::OnDetach()
{
}

bool TGE::EditorLayer::OnKeyPressed(KeyPressedEvent& e)
{
    //shortcuts
...
void TGE::EditorLayer::NewScene()
{
    m_ActiveScene = std::make_shared<Scene>();
    m_ActiveScene->OnViewportResize((uint32_t)m_ViewportSize.x, (uint32_t)m_ViewportSize.y);
    m_SHP.SetContext(m_ActiveScene);
}
void TGE::EditorLayer::OpenScene()
{
...
void TGE::EditorLayer::SaveSceneAs()
{
